...
echo "======================================"
echo "TSM BNCA AUTONOMOUS ENGINE v1 APPLY"
echo "======================================"

FILE="html/core/tsm-bnca-autonomous.js"

mkdir -p html/core

echo "[1] Writing BNCA Autonomous Engine..."
...
echo "[2] Wiring BNCA into construction portal..."

PORTAL="html/construction-suite/construction-executive-portal.html"

if [ -f "$PORTAL" ]; then
  grep -q "tsm-bnca-autonomous.js" "$PORTAL" || cat <<'HTML' >> "$PORTAL"

<!-- TSM BNCA AUTONOMOUS ENGINE -->
<script defer src="/core/tsm-bnca-autonomous.js"></script>

HTML

  echo "✔ BNCA script wired"
else
...
git add -A
git commit -m "BNCA Autonomous Engine v1 - event-driven execution layer" || echo "No changes"
